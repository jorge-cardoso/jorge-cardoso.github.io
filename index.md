...
+ I am looking for MSc students to work on a research project (with T-Systems and Deutsche Telekom) which evaluates the reliability of OpenStack. Drop me an e-mail if you are interrested. More information can be found [here](https://github.com/jorge-cardoso/jorge-cardoso.github.io/blob/master/documents/Master_Thesis_Cloud_Resilience_Reliability_Fault-Library-2016-04-12.pdf)   

...
News
----
+ My Lecture on *AIOps: Anomalous Span Detection in Distributed Traces Using Deep Learning* presented at [Prof. Joeran Beel's Chair](https://www.scss.tcd.ie/joeran.beel/) (Trinity College Dublin) is available at [Slideshare](https://www.slideshare.net/JorgeCardoso4/aiops-anomalous-span-detection-in-distributed-traces-using-deep-learning)

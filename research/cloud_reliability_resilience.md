...
+ The book [https://www.amazon.com/Resilience-Reliability-AWS-Jurg-Vliet/dp/1449339190](Resilience and Reliability on AWS) provides  a motivation and a few examples (for beginners) on the importance of reliability. The author shares their experience to achieve resilience and reliability with code examples to monitor Redis or MongoDB. This clearly indicates that current solutions are limited and further systmathic approaches are needed to dead with the complex problem of reliability of clouds.

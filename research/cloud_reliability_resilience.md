...
provide little insight into the distributed service’s nodes and dependencies which run across multiple machines, and possibly even multiple datacenters.

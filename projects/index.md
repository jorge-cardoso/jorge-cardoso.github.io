...
From 2015 to 2020, we worked on improving the [Cloud Reliability and Resilience](http://www.slideshare.net/JorgeCardoso4/cloud-resilience-with-open-stack) of Huawei Cloud (HC) and Open Telekom Cloud (OTC). 
Since back then HC used several components from the [OpenStack](https://docs.openstack.org/) platform,  
